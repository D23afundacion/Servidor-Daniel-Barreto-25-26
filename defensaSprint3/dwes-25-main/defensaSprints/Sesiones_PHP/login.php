...
if (mysqli_num_rows($res) > 0) {
  ...
  if (password_verify($password_posted, $row['contraseña'])) {
    ...
    echo '<p>Contraseña incorrecta</p><p><a href="/Sesiones_PHP/login.html">Volver</a></p>';
  }
} else {
  echo '<p>Usuario no encontrado con ese email</p><p><a href="/Sesiones_PHP/login.html">Volver</a></p>';
}
